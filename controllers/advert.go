...
// @Param			data_sort	query	string	integer	"Сортировка объявлений по поздним датам(late_date), свежим датам(fresh_date), по ценам по возрастанию (less_price) и по убыванию(bigger_price)"
